...
public class UpdateQuantityController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Carts cart = CartsTable.findCartsById(id);
        Integer oldQty = cart.getQty();
        cart.setQty(qty);
        int rowInserted = CartsTable.updateCarts(cart);
        request.setAttribute("rowInserted", rowInserted);
        request.setAttribute("name", cart.getName());
        request.setAttribute("old", oldQty);
        request.setAttribute("new", qty);
